...
export class LocalQuotesSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc('You can set default refresh interval (in seconds) and miss corresponding field in code block' +
		...
		new Setting(containerEl)
			...
			.setDesc('If you turn it on plugin will scan your file for new quotes when you modify it. Requires app ' +
		...
		new Setting(containerEl)
			...
			.setDesc('This setting affects on length of id that automatically generates in \'Quote Maker\'')
			.addText(text => text
